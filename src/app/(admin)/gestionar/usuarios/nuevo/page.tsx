...
// Tipos de usuarios administrativos según TipoUsuario en schema.prisma
const tiposUsuario = [
  { id: 1, valor: "admin", descripcion: "Administrador del sistema" },
  { id: 2, valor: "moderador", descripcion: "Moderador de contenido" },
  { id: 3, valor: "editor", descripcion: "Editor de contenido" },
];
